...
def generate_launch_description():
    ...
    world_file_name = 'map_241030_2.world'
    ...
    launch_file_dir_turtlebot3 = os.path.join(get_package_share_directory('turtlebot3_gazebo'), 'launch')
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([launch_file_dir_turtlebot3, '/robot_state_publisher.launch.py']),
